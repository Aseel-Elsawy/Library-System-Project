...
namespace LibrarySystemNew
{
    public partial class Sales : Form
    {
        ...
        void calcremain()
        {
            ...
            if ((double.Parse(reciept.Text)) < (double.Parse(payed.Text)))
            {
        ...
        void bindcombo()
        {
            clientname.DataSource = RetriveData.executequery("sp_customers_selectall", CommandType.StoredProcedure);
            clientname.DisplayMember = "cust_name";
            clientname.ValueMember = "cust_id";
            clientname.Text = "";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure To Save This Convert", "Converts", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                _con.cmd.CommandText = "sp_sales_insert";
                _con.cmd.Parameters.AddWithValue("@cust_id", int.Parse(clientname.SelectedValue.ToString()));
                _con.cmd.Parameters.AddWithValue("@sales_date", DateTime.Parse(datetxt.Text));
                ...
                _con.cmd.Parameters.AddWithValue("@sales_notes", notestxt.Text);
